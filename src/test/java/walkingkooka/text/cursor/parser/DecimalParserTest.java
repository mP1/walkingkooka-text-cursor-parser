...
public final class DecimalParserTest extends NonEmptyParserTestCase<DecimalParser<ParserContext>, DecimalParserToken> {
    ...
    @Test
    public void testParseZeroExponentIgnorec() {
        this.parseAndCheck2(
            "1",
            1,
            "E"
    ...
    private TextCursor parseAndCheck3(final String text,
        ...
        return this.parseAndCheck(
            ...
            text,
            ParserTokens.decimal(value, text),
            text,
            ""
        );
    }
    ...
    @Override
    public DecimalParser<ParserContext> createParser() {
    ...
    @Override
    public Class<DecimalParser<ParserContext>> type() {
